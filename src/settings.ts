...
const defaultDescs = {
	...
	"Use Advanced URI Links": "Click a link in Anki to go directly to the flashcard in your notes. Requires Advanced URI plugin and Add File Link to be on.",
...
export class SettingsTab extends PluginSettingTab {
	...
	setup_defaults() {
		...
		if (!(plugin.settings["Defaults"].hasOwnProperty("Use Advanced URI Links"))) {
			plugin.settings["Defaults"]["Use Advanced URI Links"] = false
		}
